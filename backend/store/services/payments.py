...
from ..models import CartItem, Order, OrderItem, Notification
...
def _get_webpay_transaction() -> Transaction:
    ...
    return Transaction(WebpayOptions(
        ...
        integration_type=IntegrationType.TEST if config('TBK_INTEGRATION_TYPE', default='TEST') == 'TEST' else IntegrationType.LIVE
    ))
