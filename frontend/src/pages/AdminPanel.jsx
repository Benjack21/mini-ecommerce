        ...
        {showForm && (
          <div className="admin-form">
            ...
            <div className="admin-form__grid">
              ...
              />
              <input
                className="admin-form__input--full"
        ...
        {selectedProductId && (
          <div className="admin-images">
              ...
              {productImages.map((img) => (
                <div key={img.id} className="admin-images__item">
                  ...
                  <input
                    ...
                    onBlur={(e) => {
                      if (e.target.value !== img.url) updateImage(img.id, e.target.value);
                    }}
                  />
            ...
            <div className="admin-images__footer">
              ...
              />
              <button onClick={addImage} className="admin-images__btn-add">
                Agregar
              </button>
            </div>
          </div>
              ...
              >
                <div className="admin-list__item-left">
                  <img
                    ...
                    alt={product.name}
                    className="admin-list__item-image"
                  />
                  <div>
